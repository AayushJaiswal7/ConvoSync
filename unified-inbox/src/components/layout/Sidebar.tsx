"use client"; // Needs to be a client component for selection
...
export function Sidebar() {
  return (
    <aside className="hidden h-full w-full max-w-sm flex-col border-r bg-sidebar text-sidebar-foreground sm:flex">
